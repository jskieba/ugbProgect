...
exports.allDataBossManager = exports.allDataUgbManager = void 0;
...
exports.allDataBossManager = (0, catchAsync_1.catchAsync)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.body.token.userId;
        const memberSelect = {
            "username": 1,
        ...
        const allData = yield User_1.User.findById(userId)
            ...
            "model": User_1.User,
            "select": memberSelect,
            populate: { "path": "JEFE", "model": Ugb_1.Ugb }
        });
        return (0, succes_1.endpointResponse)({ res, code: 200, message: "¡Lista de UGBS a cargo!", body: (0, helper_1.cleanUserProfile)(allData.toJSON()) });
    }
    catch (error) {
